# shell-scripts/use-config.sh

use this file to use config from configs/subdomains/
run following command to use configs/subdomains/prepare.js as config for you local environment

`shell-scripts/use-config.sh prepare`
