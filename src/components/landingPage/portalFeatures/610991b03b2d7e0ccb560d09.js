		...
		<div className="portal-features-wrapper">
			...
			>
				<div style={{ flex: 1 }} className="product-subwrapper-text">
					...
					<div style={{ fontSize: 24, color: '#0AABDC' }}>MHCET 2015-2020</div>
					<div
						style={{
							fontSize: 18,
							color: '#707070',
					...
					>
						...
						edition of JEE to keep your preparation up to date with the current
			...
			>
				<div style={{ flex: 1 }} className="margin-right">
					<div style={{ fontSize: 32, color: '#0AABDC' }}>Speedometer Monitored</div>
					...
					>
						To help you practice, we provide categorized practice questions where your
						speed and accuracy are timed precisely. This creates a behavioral pattern
						for you as you take a test and helps identify your weak areas.
					</div>
				</div>
				<div className="margin-left">
