			...
			<div className="product-wrapper portal-features-wrapper">
				...
				>
					<div style={{ flex: 1 }} className="product-subwrapper-text">
						...
						<div style={{ fontSize: 24, color: '#0AABDC' }}>CSAT 2022 - 2023</div>
						<div
							style={{
								fontSize: 18,
								color: '#707070',
						...
						>
							To ace CSAT examination, one needs to prepare dynamically according to
							the changing needs. Hence, we analyze your current position based on the
							2022 - 2024 edition of CSAT to keep your preparation up to date with the
							current requirement of the exam.
						</div>
					</div>
