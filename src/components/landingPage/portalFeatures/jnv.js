			...
			<div className="product-wrapper portal-features-wrapper">
				...
				>
					<div style={{ flex: 1 }} className="product-subwrapper-text">
						...
						<div style={{ fontSize: 24, color: '#0AABDC' }}>Examination</div>
						<div
							style={{
								fontSize: 18,
								color: '#707070',
						...
						>
							To conquer exams appropriately we offer tests in four different scales
							(1) Topic Tests, (2) Sectional Mocks, (3) Live Test & (4) Full Mocks to
							improvise student grades.
						</div>
					</div>
