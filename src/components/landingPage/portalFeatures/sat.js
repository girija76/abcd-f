			...
			<div className="product-wrapper portal-features-wrapper">
				...
				>
					<div style={{ flex: 1 }} className="product-subwrapper-text">
						...
						<div style={{ fontSize: 24, color: '#0AABDC' }}>SAT 2015-2022</div>
						<div
							style={{
								fontSize: 18,
								color: '#707070',
						...
						>
							To ace SAT examination, one needs to prepare dynamically according to the
							changing needs. Hence, we analyze your current position based on the 2022
							edition of SAT to keep your preparation up to date with the current
