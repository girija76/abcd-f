			...
			<div className="portal-features-wrapper">
				...
				>
					<div style={{ flex: 1 }} className="product-subwrapper-text">
						...
						<div style={{ fontSize: 24, color: '#0AABDC' }}>JEE 2015-2021</div>
						<div
							style={{
								fontSize: 18,
								color: '#707070',
						...
						>
							To ace the JEE examination, one needs to prepare dynamically according to
							the changing needs. Hence, we analyze your current position based on the
							2019 edition of JEE to keep your preparation up to date with the current
							requirement of the exam.
						</div>
					</div>
					<div className="margin-left">
						<img src={img1} className="portal-features-image" alt="" />
					</div>
				</div>
				<div
					style={{
				...
				>
					<div className="margin-right">
						<img src={img2} className="portal-features-image" alt="" />
					</div>
				...
				>
					...
					<div className="margin-left">
						<img src={img3} className="portal-features-image" alt="" />
					</div>
				</div>
			</div>
		);
