			...
			<div className="product-wrapper portal-features-wrapper">
				...
				>
					<div style={{ flex: 1 }} className="product-subwrapper-text">
						...
						>
							To ace IIT-JEE/NEET examination, one needs to prepare dynamically
							according to the changing needs. Hence, we analyze your current position
							based on the 2022 - 2024 edition of IIT-JEE/NEET to keep your preparation
							up to date with the current requirement of the exam.
						</div>
					</div>
					<div className="margin-left">
						<img
							src={img1}
							className="portal-features-image"
							alt="404 - Not Found"
						></img>
					</div>
				</div>
