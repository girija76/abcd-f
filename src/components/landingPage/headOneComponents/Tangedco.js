...
class HeadOne extends Component {
	...
	render = () => {
		...
		const { name, course, shortName, demo } = activeProduct;
							...
							>
								...
								>
									...
									<div>
										...
										Limited(TANGEDCO) is an electrical power generation and distribution
										public sector undertaking that is owned by the Government of Tamil
										Nadu. The Application for the post of Assistant Engineer to fill the
										600 vacancies has been announced on 24-Jan-2020(
										<a
											href="https://www.tangedco.gov.in/linkpdf/AE_NOTIFICATION_%20FINAL_PDF.pdf"
											target="_blank"
											rel="noopener noreferrer"
										>
											Click here for official notification
										</a>
										). The application has been closed on 16-March-2020.{' '}
										<i>The official exam date is yet to be announced.</i>
										<br />
										<br />
										<ol>
											<li>Assistant Electrical Engineer -400 vacancies</li>
											<li>Electrical and Electronics - 364 vacancies</li>
											<li>
												Electrical and communication Engineering/Instrumentation Engineering
												- 28 vacancies
											</li>
											<li>
												Computer Science/Information Technology Engineering - 8 vacancies
											</li>
											<li>Assistant Engineer Mechanical - 125 vacancies</li>
											<li>Assistant Engineer Civil - 75 vacancies</li>
										</ol>
										<div>
											<h3>Contact Us</h3>
											<div>
												Please feel free to contact us for any queries or service
												informations
											</div>
											<div>
												<div>
													Call Us: <a href="tel:7539920706">7539920706</a> (admin)
												</div>
												<div>
													WhatsApp:{' '}
													<a
														...
														href="https://wa.me/917539920706"
													>
														https://wa.me/917539920706
													</a>
												</div>
												<div>
													Telegram Channel:{' '}
													<a
														target="_blank"
														rel="noreferrer noopener"
														href="https://t.me/aetangedco"
													>
														https://t.me/aetangedco
													</a>
												</div>
												<div>
													Email:{' '}
													<a href="mailto:admin@onlinetangedco.com">
														admin@onlinetangedco.com
													</a>
												</div>
												<div>
													For Online Course Enquiries and Scholarships/Fees Concession{' '}
													<a
														target="_blank"
														rel="noreferrer noopener"
														href="https://forms.gle/5Dtd9gAqTMF79m4V8"
													>
														click here
													</a>
												</div>
