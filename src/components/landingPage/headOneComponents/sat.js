...
class HeadOne extends Component {
	...
	render = () => {
		...
		const detail =
			"Prepseed's prepartion portal is the most insightful and robust, equipped with newest tools like - behaviour analysis, personalized recommendations, smart practice. You just need to follow the schedule, leave the rest on Prepseed.";
		return (
			<>
								...
								<div style={{ margin: '24px 0px' }} className={`product-wrapper`}>
									...
									>
										...
										>
											...
											>
												<BiTestTube style={{ fontSize: 24, color: '#faad14' }} />
											</div>
											<div style={{ padding: 8 }}>
												<h2
													style={{
												...
												<div style={{ fontSize: 16, textAlign: 'center' }}>
													Can know more about strength & weakness
												</div>
											</div>
										</div>
									</div>
