var shortName = 'RV PARANKAR COLLEGE';
var identifier = 'rvparankar';
var logoDark =
	'https://static.prepseed.com/brand/' + identifier + '/' + identifier + '.jpg';
var logoLandscape = logoDark;
window.config = {
	_id: '610991b03b2d7e0ccb560d09',
	clientId: '610991b03b2d7e0ccb560d09',
	...
	metaData: {
		...
		resources: {
			title: 'MHCET Resources - ' + shortName,
			description: '',
		},
		courses: {
		...
		coursesJee: {
			title: 'MHCET Full Test Series (FREE) - ' + shortName,
			description:
			...
			text: 'MHCET Full Test Series',
		},
		demo: {
			title: 'Prepare for MHCET - ' + shortName,
			description:
				'Start your MHCET exam preparation with practice sessions, topic tests, live tests, mock tests and AI based behaviour and academic knowledge feedback.',
		},
		demoPractice: {
			title: 'Practice Physics, Chemistry, Maths for MHCET Exam',
			description:
		...
		demoCompete: {
			title: 'Live and Mocks Tests for MHCET Exam Preparation',
			description: 'Attempt live tests and full mocks of MHCET Exam.',
		},
	},
	sitemap: [],
