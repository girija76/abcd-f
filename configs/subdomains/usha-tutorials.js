var shortName = 'Usha Tutorials';
var identifier = 'usha-tutorials';
var logoDark =
	'https://static.prepseed.com/brand/' +
	identifier +
	'/usha-tutorials-landscape.png';
var logoLandscape =
	'https://static.prepseed.com/brand/' +
	identifier +
	'/usha-tutorials-landscape.png';
var favicon =
	'https://static.prepseed.com/brand/' +
	identifier +
	'/usha-tutorials-favicon.ico';
window.config = {
	isDummy: false,
	_id: 'jee',
	clientId: '634cf66223777d20c86f3dbf',
		...
		groups: [
			{
				...
				subgroup: '634cf819cd100d31ea6682cf',
				name: 'Demo Signup',
			},
		],
	},
