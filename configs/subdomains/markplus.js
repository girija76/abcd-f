var shortName = 'Markplus Academy';
var identifier = 'markplus';
var logoDark =
	'https://static.prepseed.com/brand/' + identifier + '/markplus-landscape.png';
var logoLandscape =
	'https://static.prepseed.com/brand/' + identifier + '/markplus-landscape.png';
var favicon =
	'https://static.prepseed.com/brand/' + identifier + '/markplus.ico';
window.config = {
	isDummy: false,
	_id: 'jee',
	clientId: '6332a338d01fd815082f1dda',
		...
		groups: [
			{
				...
				subgroup: '6332a3a319bfbf0eabfb67e8',
			},
		],
	},
