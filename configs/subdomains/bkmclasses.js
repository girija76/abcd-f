var shortName = 'BKM Classes';
window.config = {
	_id: 'coaching',
	customHeaderComponent: '',
	name: shortName,
	hideLogoOnHeadOne: false,
	logoDark: 'https://static.prepleaf.com/brand/bkmclasses/logo.png',
	logoDarkHeight: 72,
	accessMsg:
		'Your account unlocking process has been initiated. Your account will unlock soon. In case of any query please send an email to mkwayedubrain@gmail.com.',
	tpCfg: {
		dPColor: '#a6c2d0',
		dSColor: '#000',
		mPColor: '#e0e0e0',
		mSColor: '#000',
		logo: 'https://static.prepleaf.com/brand/bkmclasses/logo.png',
		logoStyle: {
			display: 'flex',
			paddingLeft: 4,
			height: '70%',
	...
	subgroups: [
		{
			_id: '5eec5d08537ae244555fac2f',
			name: 'Target 2020 BKM Classes',
		},
	],
	testCfg: {
		name: 'Tests',
