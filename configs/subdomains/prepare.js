var shortName = 'Prepseed';
var identifier = 'prepare';
var logoDark =
	'https://static.prepseed.com/brand/' + identifier + '/prepseed-landscape.png';
var logoLandscape =
	'https://static.prepseed.com/brand/' + identifier + '/logo.png';
window.config = {
	isDummy: false,
	_id: 'jee',
	clientId: '628c8a3c7640243d911a6ca7',
	...
	landingPageCfg: {
		...
		groups: [
			// is used on sign up page
			{
				...
				subgroup: '628c8a6c7640243d911a6cc4',
			},
		],
	},
