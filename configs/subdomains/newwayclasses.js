var shortName = 'New Way Classes';
var identifier = 'new-way-classes';
var logoDark =
	'https://static.prepseed.com/brand/' + identifier + '/new-way-landscape.png';
var logoLandscape =
	'https://static.prepseed.com/brand/' + identifier + '/new-way-landscape.png';
var favicon =
	'https://static.prepseed.com/brand/' + identifier + '/new-way-classes.ico';
window.config = {
	isDummy: false,
	_id: 'jee',
	clientId: '62f34ea45286a01d871a23a9',
	apiEndpoint: 'https://napi.prepseed.com',
	cookieNotRequired: false,
	customHeaderComponent: 'new-way-classes',
	name: shortName,
	...
	paymentGatewayOptions: {
		name: 'New Way Classes',
		description: 'New Way Classes - Purchase',
		image: logoLandscape,
	},
};
