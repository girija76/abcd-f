var shortName = 'Prepseed School';
var identifier = 'school';
// var logoDark =
// 	'https://static.prepseed.com/brand/' + identifier + '/logo-square.png';
var logoLandscape = 'https://static.prepseed.com/brand/your-coaching/logo.png';
window.config = {
	isDummy: true,
	_id: 'coaching',
	clientId: '61f8f2f98a1a050cf2676d54',
	...
	busRoutes: {
		...
		buses: [
			{
				url: 'https://static.prepseed.com/client/your-coaching/buses/1.pdf',
				type: 'pdf',
				name: 'Bus 1',
			},
			{
				url: 'https://static.prepseed.com/client/your-coaching/buses/2.pdf',
				type: 'pdf',
				name: 'Bus 2',
			},
			{
				url: 'https://static.prepseed.com/client/your-coaching/buses/3.pdf',
				type: 'pdf',
				name: 'Bus 3',
			},
			{
				url: 'https://static.prepseed.com/client/your-coaching/buses/4.pdf',
				type: 'pdf',
				name: 'Bus 4',
			},
		],
