var shortName = "Brother's Academy";
var logo = 'https://static.prepleaf.com/brand/brothersacademy/logo.jpg';
var logoWide =
	'https://static.prepleaf.com/brand/brothersacademy/logo-wide.jpg';
window.config = {
	clientId: '5f8bf1a87bd17424a8175ac5',
	_id: 'coaching',
	...
	usernameSuffix: '@brothersacademy.co.in',
	landingPageCfg: {
		swg: true,
		themeColor: '#1976d2',
		groups: [
	...
	liteLandingPage: {
		links: [
			{
				text: 'Fill Grand Scholarship Admission Test : G-SAT Registration Form',
				href: 'http://www.brothersacademy.co.in/admissions.php',
				target: '_blank',
			},
		],
	},
